...
[locate x=207 y=250][button normal="回忆" over="回忆_1" storage="save.ks" target=*save]
[locate x=373 y=250][button normal="记录" over="记录_1" storage="system.ks" target=*load]
[locate x=539 y=250][button normal="OK" over="OK_1" storage="system.ks" target=*ok]
